...
STRING_LITERAL(TMP693, "0123456789ABCDEF", 16);
	...
	result = mnewString(len);
	{
		...
		res_95395 = HEX3Atmp_95392;
		{
			...
			while (1) {
				...
				nimln(401, "strutils.nim");
				nimln(401, "strutils.nim");
				if ((NU)((NI32)(((NI32)(NU32)(NU64)((NI64)((NU64)(x) >> (NU64)(shift)))) & ((NI32) 15))) > (NU)(((NimStringDesc*) &TMP693)->Sup.len)) raiseIndexError();
				result->data[j_95388] = ((NimStringDesc*) &TMP693)->data[(NI32)(((NI32)(NU32)(NU64)((NI64)((NU64)(x) >> (NU64)(shift)))) & ((NI32) 15))];
				nimln(402, "strutils.nim");
				nimln(402, "strutils.nim");
				TMP694 = addInt64(shift, 4);
				shift = (NI64)(TMP694);
...
N_NIMCALL(NI, nsuParseHexInt)(NimStringDesc* s) {
	...
	nimln(451, "strutils.nim");
	{
		...
		nimln(451, "strutils.nim");
		TMP700 = addInt(i, 1);
		if ((NU)((NI64)(TMP700)) > (NU)(s->Sup.len)) raiseIndexError();
		LOC5 = ((NU8)(s->data[(NI64)(TMP700)]) == (NU8)(120));
		if (LOC5) goto LA6;
		nimln(451, "strutils.nim");
		nimln(451, "strutils.nim");
		TMP701 = addInt(i, 1);
		if ((NU)((NI64)(TMP701)) > (NU)(s->Sup.len)) raiseIndexError();
		LOC5 = ((NU8)(s->data[(NI64)(TMP701)]) == (NU8)(88));
		LA6: ;
		LOC3 = LOC5;
		LA4: ;
		if (!LOC3) goto LA7;
	...
	LA1: ;
	{
		...
		while (1) {
			...
			case 48 ... 57:
			{
				...
				nimln(457, "strutils.nim");
				if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
				TMP702 = subInt(((NI) (((NU8)(s->data[i])))), 48);
			...
			case 97 ... 102:
			{
				...
				nimln(460, "strutils.nim");
				if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
				TMP703 = subInt(((NI) (((NU8)(s->data[i])))), 97);
			...
			case 65 ... 70:
			{
				...
				nimln(463, "strutils.nim");
				if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
				TMP705 = subInt(((NI) (((NU8)(s->data[i])))), 65);
				TMP706 = addInt(((NI) ((NI64)(TMP705))), 10);
				result = (NI)((NI)((NU64)(result) << (NU64)(4)) | ((NI) ((NI64)(TMP706))));
