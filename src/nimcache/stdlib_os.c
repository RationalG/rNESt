...
STRING_LITERAL(TMP342, "", 0);
STRING_LITERAL(TMP343, "unknown OS error", 16);
...
N_NIMCALL(NimStringDesc*, oserrormsg_111020)(NI32 errorcode) {
	...
	result = 0;
	nimln(245, "os.nim");
	result = copyString(((NimStringDesc*) &TMP342));
	nimln(247, "os.nim");
	{
		NI16* msgbuf;
		nimln(247, "os.nim");
...
N_NIMCALL(void, raiseoserror_111435)(NI32 errorcode) {
	...
	nimln(275, "os.nim");
	{
		...
		nimln(276, "os.nim");
		LOC5 = 0;
		LOC5 = (*e).Sup.Sup.message; (*e).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP343));
...
N_NIMCALL(TY13206*, nosparseCmdLine)(NimStringDesc* c) {
	...
	i = 0;
	nimln(1475, "os.nim");
	a = copyString(((NimStringDesc*) &TMP342));
	{
		nimln(1476, "os.nim");
		while (1) {
			NIM_BOOL inquote;
					...
					case 92:
					{
						...
						nimln(1490, "os.nim");
						{
							...
							if (!((NU8)(c->data[j]) == (NU8)(34))) goto LA23;
							{
								...
								nimln(1491, "os.nim");
								TMP752 = subInt(j, i);
								TMP753 = divInt((NI64)(TMP752), 2);
								HEX3Atmp_123110 = (NI64)(TMP753);
							...
							nimln(1492, "os.nim");
							{
								...
								nimln(1492, "os.nim");
								TMP754 = subInt(j, i);
								TMP755 = modInt((NI64)(TMP754), 2);
								if (!(((NI) ((NI64)(TMP755))) == 0)) goto LA30;
								nimln(1493, "os.nim");
								i = j;
							}
							goto LA28;
